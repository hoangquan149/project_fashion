...
@section('main')
    <div class="main_content_iner ">
        <div class="container-fluid plr_30 body_white_bg pt_30">
            <form action="{{route('banner.update',$data->id)}}" data-id="{{$data->id}}" method="post" class="form-data" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                    ...
                    <div class="col-5">
                        ...
                        <div class="form-group">
                            ...
                            <div class="image-edit" style="display: flex;justify-content: center;">
                                <img width="350px" src="{{url('uploads/banner')}}/{{$data->image}}" alt="">
                            </div>
