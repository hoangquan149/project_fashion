                            ...
                            <div class="box_right d-flex lms_block">
                                <div class="form-group mr-5">
                                    <select name="sort" id="sort" class="form-control"
                                        ...
                                        <option value="?sort_by=name_desc">Tên (A - Z)</option>
                                        <option value="?sort_by?=name_asc">Tên (Z - A)</option>
                                        <option value="category">Bỏ sắp xếp</option>
                                    </select>
                                </div>
                                ...
                                <div class="add_button ml-10">
                                    <a href="{{route('category.create')}}" class="btn_1">Add New</a>
                                </div>
                            </div>
                        </div>
                        <div class="QA_table ">
                                ...
                                @isset($data)
                                    @foreach($data as $value)
                                        <tr class="product-item">
                                            ...
                                            <td>
                                                <a href="{{route('category.edit',$value->id)}}" style="cursor: pointer;color: #8a8d92" class="" ><i style="font-size: 20px" class="fas fa-edit"></i></a>
