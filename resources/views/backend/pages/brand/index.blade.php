                            ...
                            <div class="box_right d-flex lms_block">
                                <div class="form-group mr-5">
                                    <select name="sort" id="sort" class="form-control"
                                        ...
                                        <option value="brand">Bỏ sắp xếp</option>
                                    </select>
                                </div>
                                ...
                                <div class="add_button ml-10">
                                    <a href="{{route('brand.create')}}" class="btn_1">Add New</a>
                                </div>
                            </div>
                        </div>
                        <div class="QA_table ">
                                ...
                                @isset($brand)
                                    @foreach($brand as $value)
                                        <tr class="product-item">
                                            ...
                                            <td>
                                                <a href="{{route('brand.edit',$value->id)}}" style="cursor: pointer;color: #8a8d92" class="" >
