                            ...
                            <div class="box_right d-flex lms_block">
                                <div class="form-group mr-5">
                                    <select name="sort" id="sort" class="form-control"
                                        ...
                                        <option value="?sort_by=created_at_desc">Size mới nhất</option>
                                        <option value="?sort_by=created_at_asc">Size cũ nhất</option>
                                        <option value="size">Bỏ sắp xếp</option>
                                    </select>
                                </div>
                                ...
                                <div class="add_button ml-10">
                                    <a href="{{route('size.create')}}" class="btn_1">Add New</a>
                                </div>
                            </div>
                        </div>
                        <div class="QA_table ">
...
{{--                                            <td>{{($value->status==1)?'Hiện':'Ẩn'}}</td>--}}
                                            <td>
                                                <a href="{{route('size.edit',$value->id)}}" style="cursor: pointer;color: #8a8d92" class="" >
